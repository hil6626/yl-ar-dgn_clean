...
# 检查状态
curl http://0.0.0.0:5500/api/ar/nodes/ar-backend
...
class IntegrationTest:
    def setup_class(self):
        """测试前准备"""
        self.yl_monitor_url = "http://0.0.0.0:5500"
        self.ar_backend_url = "http://0.0.0.0:5501"
        self.user_gui_url = "http://0.0.0.0:5502"
