...
- **监控服务**: 独立HTTP监控端点 (端口5501)，供YL-monitor统一监控
...
# 查看服务状态
curl http://0.0.0.0:5501/api/status
```

### 2.5 监控服务启动

```bash
# 启动独立监控服务（供YL-monitor监控）
...
| 版本 | 日期 | 说明 |
|------|------|------|
| 3.2.0 | 2026-02-16 | 更新阶段2完成状态，同步部署进度 |
| 3.1.0 | 2026-02-16 | 添加监控服务文档，更新部署状态 |
